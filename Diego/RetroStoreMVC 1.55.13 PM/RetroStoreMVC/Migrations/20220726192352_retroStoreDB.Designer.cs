...
namespace RetroStoreMVC.Migrations
{
    ...
    [Migration("20220726192352_retroStoreDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoGameStore2.Models.AuthenticateUser", b =>
                {
            ...
            modelBuilder.Entity("VideoGameStore2.Models.CustomerContact", b =>
                {
                    b.Property<string>("userName")
                        .HasMaxLength(30)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("VideoGameStore2.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("VideoGameStore2.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("VideoGameStore2.Models.Ranking", b =>
                {
                    b.Property<int>("productId")
                        .HasColumnType("int")
                        .HasColumnName("productId");

                    b.Property<int?>("RankingproductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RankingproductId");

                    b.ToTable("tbl_ProductRanking", (string)null);
                });

            modelBuilder.Entity("VideoGameStore2.Models.Register", b =>
                {
                    b.Property<string>("userName")
                        .HasMaxLength(30)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("VideoGameStore2.Models.Order", b =>
                {
                    b.HasOne("VideoGameStore2.Models.Register", null)
                        .WithMany("OrderList")
            ...
            modelBuilder.Entity("VideoGameStore2.Models.Ranking", b =>
                {
                    b.HasOne("VideoGameStore2.Models.Ranking", null)
                        .WithMany("Rankings")
                        .HasForeignKey("RankingproductId");
                });
